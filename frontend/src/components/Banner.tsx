 ...
 
      {
       return  banner && isLong ? (
        ...
        <img className="h-[230px] w-[1292px] justify-center" src={ banner } />
            ...
            <div className= "h-[264px] w-full bg-gray-100 object-center mt-5 justify-center">
...
export const LongBanner = () => {
    ...
    return (
        ...
        <div className="grid text-center">
            ...
            <span className="text-lg font-thin ">But, sell and find just about anything using</span>
